...
export async function browseDirectory(
  ...
  return await invoke("browse_directory", { deviceIp, port, path, offset, limit });
}
...
export async function getTrustedDeviceList(): Promise<import("./types").PairedDeviceInfo[]> {
...
export async function getChatMessages(): Promise<import("./types").ChatEntry[]> {
  return await invoke("get_chat_messages");
}

export async function sendChatMessage(text: string, toId?: string): Promise<void> {
  await invoke("send_chat_message", { text, toId: toId || null });
}

export async function sendChatFile(localPath: string, toId?: string): Promise<void> {
...
export async function getTransferStats(): Promise<import("./types").TransferStats> {
